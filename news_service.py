...
CATEGORY_KEYWORDS = {
    ...
    "saude": [
        ...
        "anvisa", "cirurgia", "câncer", "cancer", "diabetes", "dengue",
        "gripe", "covid", "internado", "internada", "uti ",
        "medicamento", "remédio", "exame", "consulta médica",
        "obesidade", "nutrição", "dieta", "alzheimer", "avc ",
        "infarto", "hipertensão", "colesterol", "autismo",
    ],
    "policial": [
        "homicídio", "homicidio", "assassinato", "assassino", "assassina",
        "criminoso", "criminosa", "bandido", "bandida",
        "tráfico de drogas", "traficante", "cocaína", "maconha apreendida",
        ...
        "estupro", "feminicídio", "feminicidio", "latrocínio", "latrocinio",
        "facção", "faccao", "quadrilha", "organização criminosa",
        "operação policial", "mandado de prisão", "busca e apreensão",
        "tiroteio", "bala perdida", "baleado", "baleada", "esfaqueado", "esfaqueada",
        "corpo encontrado", "cadáver", "vítima fatal",
        "estelionato", "milícia", "milicia", "pistoleiro", "execução",
        "inquérito", "indiciado", "indiciada", "foragido", "foragida",
...
EXCLUSION_KEYWORDS = {
    ...
    "policial": [
        "guerra", "israel", "palestina", "hamas", "ucrânia", "rússia",
        "otan", "gaza", "cessar-fogo", "bombardeio", "míssil",
        "exército", "tropas", "fronteira internacional",
        "futebol", "campeonato", "brasileirão", "jogador",
        "filme", "cinema", "netflix", "série",
        "bbb", "big brother", "paredão",
        "impeachment", "stf julga", "senado", "câmara dos deputados",
    ],
}
