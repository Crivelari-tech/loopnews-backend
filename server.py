            ...
            response = await client.post(
                ...
                json={
                    ...
                    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
                        <h1 style="color: #3B82F6; text-align: center;">LoopNews</h1>
                        <h2 style="text-align: center;">Seu código de verificação</h2>
                        <div style="background-color: #f3f4f6; padding: 30px; border-radius: 10px; text-align: center; margin: 20px 0;">
                        ...
                        <p style="color: #6b7280; text-align: center;">Se você não solicitou este código, ignore este email.</p>
                    </div>
                    """
                }
            )
...
async def verify_code(request: VerifyCodeRequest, response: Response):
    ...
    logger.info(f"User authenticated via email code: {email}")
